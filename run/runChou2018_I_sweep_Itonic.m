...
% s.populations(1).parameters = {'Itonic',0.51, 'noise',0}; % no noise
% s.populations(1).parameters = {'Itonic',0.51, 'noise',0.01}; % low noise
s.populations(1).parameters = {'Itonic',0.51, 'noise',0.03}; % med noise
% s.populations(1).parameters = {'Itonic',0.51, 'noise',0.1}; % high noise
