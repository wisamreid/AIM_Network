...
h2 = netcon_spread(cf/1000,8,'bw',-0.3);
IEnetconOld = 1 - h1 - 0.5;
IEnetconOld(IEnetconOld<0) =  0;
IEnetcon = h2*0.6-h1; %scalar controls height of side lobes
...
legend('EC spread','IE spread new','IE spread new old')
